...
#include "Polynomial - Student ID - mid2.h"
...
/*
int main() {
	Polynomial<  list< Term > > multiplicand1[numTestCases];
	Polynomial<  list< Term > > multiplier1[numTestCases];
	input(multiplicand1, multiplier1);

	for (int i = 0; i < numTestCases; i++){
		//cout << multiplicand1[i] << endl;
		//cout << multiplier1[i] << endl;
		cout << multiplicand1[i]*multiplier1[i] << endl << endl;
	}
